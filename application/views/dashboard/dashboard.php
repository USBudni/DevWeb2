            ...
            <ul class="nav navbar-top-links navbar-right">
                ...
                <div class="row  border-bottom white-bg dashboard-header">
                    ...
                    <div class="col-md-3">
                        ...
                        <small>Você teve 40 novas menções.</small>
                    </div>
                    <div class="col-md-9">
                        ...
                        <div class="col-lg-6">
                            <div class="ibox float-e-margins">
                                <div class="ibox-title">
                                    <h5>Mentions no mês - <span class="month-year"></span></h5>
                                </div>
                                <div class="ibox-content text-center">
                                    <div>
                                        <div class="bar_dashboard">5,3,9,6,5,9,7,3,5,2,4,7,3,2,7,9,6,4,5,7,3,2,1,0,9,5,6,8,3,2,1</div>
                                        </div>
                                    </div>
                                </div>
                            <div class="ibox float-e-margins">
                                <div class="ibox-title">
                                    <h5>Índice de crescimento de seguidores</h5>
                                </div>
